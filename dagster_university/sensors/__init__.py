...
def adhoc_request_sensor(context):
    PATH_TO_REQUEST = os.path.join(os.path.dirname(__file__), "../../", "data/requests")
    ...
    for filename in os.listdir(PATH_TO_REQUEST):
        file_path = os.path.join(PATH_TO_REQUEST, filename)
